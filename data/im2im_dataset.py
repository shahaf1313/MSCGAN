...
class Im2imDataset(domainAdaptationDataSet):
    def __init__(self, root, scale_factor, num_scales, curr_scale, set, get_image_label=False):
        super(Im2imDataset, self).__init__(root, None, scale_factor, num_scales, curr_scale, set, get_image_label=get_image_label)
        self.domain_a_ids = osp.join(root, 'trainA')
    def __len__(self):
