def main(opt):
    if opt.train_im2im_pyramid:
        ...
        opt.source_loaders, opt.target_loaders = [], []
...
#         opt.curr_scale = i
#         source_loader, target_loader = CreateSrcDataLoader(opt, get_image_label=True), CreateTrgDataLoader(opt, generate_prev_image=True)
